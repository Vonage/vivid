...
describe('vwc-lit-icon', ()=> {
	...
	describe('custom component registration', function() {
		it('Should be defined', function() {
			assert.exists(customElements.get('vwc-lit-icon', 'vwc-lit-icon element is defined'));
		});
	});
	...
	describe('component behaviour', function() {
		...
		beforeEach(() => {
			iconEl = document.createElement('vwc-lit-icon');
