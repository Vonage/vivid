...
Default.args = {
	value: 30, min: 0, max: 100, change: continuousChange
};

export const Pin = Template.bind({});
Pin.args = {
	value: 70, min: 0, max: 119, step: 5, pin: '', change: descreteWithPinChange
};

export const Markers = Template.bind({});
Markers.args = {
	value: 10, min: 0, max: 70, step: 10, pin: '', markers: '', change: discreteWithMarkerChange
};
...
Autofocus.args = {
	value: 33, step: 10, markers: true, autofocus: true
};
