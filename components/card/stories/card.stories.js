...
TopAction.args = {
	...
	'card-text': 'Lorem ipsum dolor sit amet, consectet adipiscing elit'
};
...
CardFooter.args = {
	label: 'Footer',
	heading: 'Footer',
	'card-text': 'Use the \'footer\' slot in order to add actionable items.'
};
...
const inAGridCards = new Array(9).fill(0)
	.reduce((htmlString, val, index) => {
		htmlString += `
			<vwc-card heading="Card ${index + 1}" header-icon="chat-line" subtitle="Card no. ${index + 1}" card-text="This is the right card for you!">
				<div style="height: 150px; width: 100%; background-color: #871EFF;" slot="media"></div>
				<vwc-button slot="footer" shape="pill" layout="outlined" icon="info">Click</vwc-button>
			</vwc-card>
	`;
...
const InAGridTemplate = args => html`
	...
	<div class="card-wrapper">
		<vwc-card heading="Card 1" header-icon="chat-line" subtitle="Card no. 1"
							card-text="This is the right card for you!">
			<div style="height: 150px; width: 100%; background-color: #871EFF;" slot="media"></div>
			<vwc-button slot="footer" shape="pill" layout="outlined" icon="info">Click</vwc-button>
		</vwc-card>
