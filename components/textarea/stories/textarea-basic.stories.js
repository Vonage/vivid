...
export const basic = () => html`
	...
	<h3>Required</h3>
	<vwc-textarea outlined required label="Vwc textarea" value="Clean to see validation effect" validationMessage="Required field" @keydown=${handleKeyDown}></vwc-textarea>
`;
