...
const Template = args => html`<vwc-textarea ...=${spread(args)} @keydown=${handleKeyDown}></vwc-textarea>`;
...
Resizable.args = {
	outlined: '', dense: '', label: 'VWC Textarea', resizable: ''
};

export const Disabled = Template.bind({});
Disabled.args = {
	outlined: '', disabled: '', label: 'VWC Textarea', value: 'Something'
};
...
Required.args = {
	...
	required: '',
	label: 'VWC Textarea',
	value: 'Clean to see validation effect',
