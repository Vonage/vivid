...
export class VWCButton extends MWCButton {
	...
	protected getRenderClasses() {
		return classMap({
			...
			'vwc-button--color-connotation-primary': this.connotation == 'primary',
			'vwc-button--color-connotation-cta': this.connotation == 'cta',
			'vwc-button--color-connotation-success': this.connotation == 'success',
			'vwc-button--color-connotation-alert': this.connotation == 'alert',
			'vwc-button--color-connotation-info': this.connotation == 'info',
			'vwc-button--color-connotation-announcement': this.connotation == 'announcement',
