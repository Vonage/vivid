...
class AccessibleBannerMessage extends AsyncDirective {
  ...
  constructor(partInfo: PartInfo) {
  	...
  	if (partInfo.type !== PartType.CHILD) {
  		throw new Error('AccessibleBannerMessage only supports child parts.');
  	}
  }
...
export const accessibleBannerMessage = directive(AccessibleBannerMessage);
