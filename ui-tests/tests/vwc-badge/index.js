...
export async function createElementVariations(wrapper) {
	...
	badgeElementWrapper.innerHTML = `
		...
		<vwc-badge connotation="cta" layout="filled" text="my badge" icon="thumbs-down-line" iconTrailing="thumbs-up-line"></vwc-badge>
		<vwc-badge connotation="cta" layout="soft" text="my badge" icon="thumbs-down-line" iconTrailing="thumbs-up-line"></vwc-badge>
		...
		<vwc-badge layout="filled" dense text="my badge" icon="thumbs-down-line" iconTrailing="thumbs-up-line"></vwc-badge>
		<vwc-badge layout="filled" enlarged text="my badge" icon="thumbs-down-line" iconTrailing="thumbs-up-line"></vwc-badge>
	`;
